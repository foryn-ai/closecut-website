...
export const SITE_COPY = {
  ...
  footer: {
    locationsLabel: "Practice location",
    locationsText: "160 NW Gilman Blvd, Suite 332, Issaquah, WA 98027",
    contactLabel: "Contact",
    contactText: "425-961-9767",
    privacyLabel: "Privacy",
    privacyText: "Please avoid sharing sensitive details by email or form.",
